...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 5 - Cesar Sanchez", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, glm::radians(falanje1), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		model = glm::rotate(model, glm::radians(falanje2), glm::vec3(0.0f, 0.0f, 1.0f));
		modelTemp2 = modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
